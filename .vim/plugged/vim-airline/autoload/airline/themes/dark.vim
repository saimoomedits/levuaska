...
" The dark.vim theme:
let s:airline_a_normal   = [ '#b5e8e0' , '#96cdfb' , 234  , 12 ]
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#96cdfb' , 1     ,  0    , ''     ] ,
      \ 'airline_b': [ '#ffffff' , '#96cdfb' , 4     ,  0    , ''     ] ,  
      \ }


let s:airline_a_insert = [ '#92d2e8' , '#96cdfb' , 234  , 5  ]
...
let g:airline#themes#dark#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#e08b8b' , 234 , 6     , ''     ]
...
let g:airline#themes#dark#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 3     , 0      , ''     ] ,
      \ }


let s:airline_a_inactive = [ '#4e4e4e' , '#1e1e28' , 12 , 0 , '' ]
let s:airline_b_inactive = [ '#4e4e4e' , '#1e1e28' , 12 , 0 , '' ]
let s:airline_c_inactive = [ '#4e4e4e' , '#1e1e28' , 12 , 0 , '' ]
...
let g:airline#themes#dark#palette.commandline.airline_warning = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]
let g:airline#themes#dark#palette.commandline.airline_error = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]
