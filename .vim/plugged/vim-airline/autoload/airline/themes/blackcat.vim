...
" The dark.vim theme:
let s:airline_a_normal   = [ '#b5e8e0' , '#96cdfb' , 0  , 12 ]
let s:airline_b_normal   = [ '#ffffff' , '#1e1e28' , 7 , 0 ]
let s:airline_c_normal   = [ '#9cffd3' , '#1e1e28' , 7  , 0 ]
let s:airline_z_normal   = [ '#9cffd3' , '#1e1e28' , 12  , 0 ]
...
let g:airline#themes#dark#palette.normal.airline_warning = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]
let g:airline#themes#dark#palette.normal.modified = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]
let g:airline#themes#dark#palette.normal.airline_error = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]

" It should be noted the above is equivalent to:
" let g:airline#themes#dark#palette.normal = airline#themes#generate_color_map(
"    \  [ '#00005f' , '#ffd7af' , 17  , 190 ],  " section airline_a
...
"    \  'airline_a': [ '#1e1e28' , '#fae3b0' , 17  , 190 ],  "section airline_a
"    \  'airline_b': [ '#ffffff' , '#444444' , 255 , 238 ],  "section airline_b
"    \  'airline_c': [ '#9cffd3' , '#1e1e28' , 85  , 234 ],  "section airline_c
"    \  'airline_x': [ '#9cffd3' , '#1e1e28' , 85  , 234 ],  "section airline_x
"    \  'airline_y': [ '#ffffff' , '#444444' , 255 , 238 ],  "section airline_y
"    \  'airline_z': [ '#1e1e28' , '#fae3b0' , 17  , 190 ]   "section airline_z
"    \}
"
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#96cdfb' , 1     ,  234    , ''     ] ,
      \ }


let s:airline_a_insert = [ '#92d2e8' , '#96cdfb' , 0  , 5 ]
let s:airline_b_insert = [ '#1a1823' , '#ddb6f2' , 5 , 0  ]
let s:airline_c_insert = [ '#1a1823' , '#ddb6f2' , 5  , 0 ]
...
let g:airline#themes#dark#palette.insert_modified = {
      \ 'airline_c': [ '#d9e0ee' , '#f28fad' , 6     , 0      , ''     ] ,
      \ }
let g:airline#themes#dark#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#fae3b0' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }
...
let g:airline#themes#dark#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#e08b8b' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#dark#palette.replace_modified = g:airline#themes#dark#palette.insert_modified
let g:airline#themes#dark#palette.insert.airline_warning = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]
let g:airline#themes#dark#palette.insert.airline_error = [ '#1e1e28' , '#e28c8c' , 234 , 1  ]


let s:airline_a_visual = [ '#1a1823' , '#abe9b3' , 2 , 0 ]
let s:airline_b_visual = [ '#1a1823' , '#fae3b0' , 3 , 0 ]
let s:airline_c_visual = [ '#1a1823' , '#e28c8c' , 4  , 0  ]
...
let g:airline#themes#dark#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 117     , 0      , ''     ] ,
      \ }


let s:airline_a_inactive = [ '#4e4e4e' , '#1e1e28' , 245 , 234 , '' ]
let s:airline_b_inactive = [ '#4e4e4e' , '#1e1e28' , 245 , 235 , '' ]
let s:airline_c_inactive = [ '#4e4e4e' , '#1e1e28' , 245 , 236 , '' ]
...
let s:airline_a_commandline = [ '#ddb6f2' , '#abe9b3' , 0  , 2 ]
let s:airline_b_commandline = [ '#ffffff' , '#1e1e28' , 2 , 0 ]
let s:airline_c_commandline = [ '#9cffd3' , '#1e1e28' , 2  , 0 ]
...
let g:airline#themes#dark#palette.commandline.airline_warning = [ '#1e1e28' , '#e28c8c' , 234 , 0  ]
let g:airline#themes#dark#palette.commandline.airline_error = [ '#1e1e28' , '#e28c8c' , 234 , 0  ]
